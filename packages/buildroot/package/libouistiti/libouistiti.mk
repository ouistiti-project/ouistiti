...
ifeq (findstring y,$(BR2_STATIC_LIBS))
...
OUISTITI_CONFIGURE_OPTS+=HTTPCLIENT_FEATURE=$(BR2_PACKAGE_LIBOUISTITI_CLIENT)

OUISTITI_CONFIGURE_OPTS+=MBEDTLS=$(BR2_PACKAGE_LIBOUISTITI_MBEDTLS)
OUISTITI_CONFIGURE_OPTS+=OPENSSL=$(BR2_PACKAGE_LIBOUISTITI_OPENSSL)
OUISTITI_CONFIGURE_OPTS+=WOLFSSL=$(BR2_PACKAGE_LIBOUISTITI_WOLFSSL)
OUISTITI_CONFIGURE_OPTS+=LIBWEBSOCKET=$(BR2_PACKAGE_LIBOUISTITI_WEBSOCKET)
